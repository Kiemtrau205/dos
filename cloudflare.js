...
const proxies = fs.readFileSync("ProxyViet.txt", 'utf-8').toString().split("\n");

const url = process.argv[2]
const time = process.argv[3]
if (process.argv.length < 4) {
  console.log("usage: node file.js url time");
  process.exit(0)
}
		...
		if (res && res.statusCode == 403) {
			reqBypass({
				...
				headers: {
					...
					'Accept-Encoding': 'deflate, gzip;q=1.0, *;q=0.5, br, gzip, deflate, *',
					'Accept-Language': 'en-US,en;q=0.9,he-IL;q=0.8,he;q=0.7,tr;q=0.6',
